...
| `bullmq.job.status` | Status of the job (completed, failed, delayed, retried, waiting, waiting-children). Deprecated and will be removed in a future breaking change. |
