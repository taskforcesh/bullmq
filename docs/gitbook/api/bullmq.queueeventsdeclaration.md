...
|  [on(event, listener)](./bullmq.queueeventsdeclaration.on_2.md) | Listen to 'cleaned' event.<!-- -->This event is triggered when a cleaned method is triggered. |
|  [on(event, listener)](./bullmq.queueeventsdeclaration.on_3.md) | Listen to 'completed' event.<!-- -->This event is triggered when a job has successfully completed. |
