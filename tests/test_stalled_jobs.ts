...
describe('stalled jobs', function () {
  ...
  describe('when maxStalledCount is provided as null', function () {
    it('use default value 1 and process stalled jobs when starting a queue', async function () {
      this.timeout(5000);
